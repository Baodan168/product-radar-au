...
- 重建版改用 sources.amazon_au._curl_fetch（curl_cffi + AUD cookies）。
  实测：Scrapling 抓 amazon.com.au/dp/{asin} 返回 200 + 空 body（被反爬），
...
from sources.amazon_au import _curl_fetch
