...
def fetch_demand_signals():
    ...
    queries = [
        "Google Trends Australia trending products rising summer 2026",
        "Australia consumer trending products summer 2026 popular",
        "trending products Australia summer 2026 what people buying",
    ]
...
def extract_trending_keywords(signals_text):
    ...
    keywords = []
    # Summer trending product categories in Australia
    trend_words = [
