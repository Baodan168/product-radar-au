#!/usr/bin/env python3
"""TikTok AU trend fetcher - extracts trending product CATEGORIES"""
...
def fetch():
    ...
    queries = [
        "TikTok trending products Australia under 20 dollars 2026",
        "TikTok made me buy it Australia viral products 2026",
        "trending TikTok products Australia home kitchen accessories gadgets",
        "TikTok viral products under 20 Australia small items useful",
    ]
    ...
    print(f"  TikTok AU: {len(all_categories)} trending categories", file=sys.stderr)
